...
const BookmarkButton = ({ postId, initalState }: BookmarkButtonProps) => {
    ...
    const { mutate } = useMutation({
        ...
        ? kyInstance.delete(`/api/posts/${postId}/bookmark`) : kyInstance.post(`/api/posts/${postId}/bookmark`),
        onMutate: async () => {
            toast({
                description: `Post ${data.isBookmarkedByUser ? "un" : ""}saved`
            })
